...
// WalkinList.jsx (FULL PAGE) ✅ Employees data fix added (NO other logic changed)
...
const WalkinList = ({
  ...
  // ✅ Employees list (for InlineEmployeeSelector) — FIX
  ...
  const fetchEmployees = async () => {
    ...
    try {
      ...
      setEmployees(Array.isArray(found) ? found : []);
    } catch (e) {
      setEmployees([]);
    } finally {
  ...
  // ✅ fetch employees when employee modal opens — FIX
  useEffect(() => {
    ...
    <>
      ...
      {currentWalkin && (
        <InlineEmployeeSelector
          ...
          walkin={currentWalkin}
          employees={employees} // ✅ FIX: pass employees list
          employeesLoading={employeesLoading} // ✅ FIX: pass loading
          onEmployeesSelected={(selectedEmployees) =>
            handleEmployeesSelected(currentWalkin._id, selectedEmployees)
          }
        />
